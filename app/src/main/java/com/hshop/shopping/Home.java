...
import com.hshop.adapter.SelectLatestHomeDetailAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        adapter.SetOnItemClickListener(new SelectHomeDetailAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                startActivity(new Intent(getActivity(), Product_details.class).putExtra("type","proid").putExtra("pro_id", getallHomeAllProductLists.get(position).getPro_id()).putExtra("pro_name", getallHomeAllProductLists.get(position).getPro_name()));
            }
        });
        ...
        adapter3.SetOnItemClickListener(new SelectLatestHomeDetailAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {
                startActivity(new Intent(getActivity(), Product_details.class).putExtra("type","proid").putExtra("pro_id", getallLatestHomeAllProductLists.get(position).getPro_id()).putExtra("pro_name", getallLatestHomeAllProductLists.get(position).getPro_name()));
            }
        });
        adapter.SetOnItemClickListener(new SelectHomeDetailAdapter.OnItemClickListener() {
            @Override
